...
import {UpdateProductReviewCommand, updateProductReviewCodec} from '@shop-backend/product-review/application/commands/update-product-review';
...
export class ProductReviewPutController {
    ...
    async run(req: Request, res: Response): Promise<void> {
        try {
            const {id, productId, userId, rating, comment} = ParamsParser.parse<Primitives<UpdateProductReviewCommand>>(req.body, updateProductReviewCodec);
