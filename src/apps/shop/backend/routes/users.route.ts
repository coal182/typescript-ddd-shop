...
export const register = (app: Express, container: ContainerBuilder): void => {
    ...
    const userGetAllController: UserGetAllController = container.get('Apps.Shop.Backend.controllers.UserGetAllController');
    const userGetByIdController: UserGetByIdController = container.get('Apps.Shop.Backend.controllers.UserGetByIdController');
    const userGetByCriteriaController: UserGetByCriteriaController = container.get('Apps.Shop.Backend.controllers.UserGetByCriteriaController');

    const userPutController: UserPutController = container.get('Apps.Shop.Backend.controllers.UserPutController');
    const userPutPasswordController: UserPutPasswordController = container.get('Apps.Shop.Backend.controllers.UserPutPasswordController');
