...
export const register = (app: Express, container: ContainerBuilder): void => {
    const productReviewPostController: ProductReviewPostController = container.get('Apps.Shop.Backend.controllers.ProductReviewPostController');

    const productReviewPutController: ProductReviewPutController = container.get('Apps.Shop.Backend.controllers.ProductReviewPutController');
    ...
    app.get('/product-review/product/:id', productReviewGetByProductIdController.run.bind(productReviewGetByProductIdController));
};
