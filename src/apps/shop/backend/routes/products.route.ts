...
export const register = (app: Express, container: ContainerBuilder): void => {
    const productGetAllController: ProductGetAllController = container.get('Apps.Shop.Backend.controllers.ProductGetAllController');
    const productGetByIdController: ProductGetByIdController = container.get('Apps.Shop.Backend.controllers.ProductGetByIdController');
    const productGetByCriteriaController: ProductGetByCriteriaController = container.get('Apps.Shop.Backend.controllers.ProductGetByCriteriaController');
