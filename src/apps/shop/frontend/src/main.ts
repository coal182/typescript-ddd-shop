...
import {lucideList, lucideLogIn, lucideLogOut, lucideMenu, lucidePencil, lucideSave, lucideShare2, lucideShoppingCart, lucideStar, lucideUserCog, lucideUserPlus} from '@ng-icons/lucide';
...
bootstrapApplication(AppComponent, {
    providers: [
        ...
        provideIcons({lucideLogIn, lucideShoppingCart, lucideMenu, lucideUserCog, lucideList, lucideLogOut, lucideUserPlus, lucideShare2, lucideSave, lucidePencil, lucideStar}),
