...
export const register = (app: Express, container: ContainerBuilder): void => {
    const productPostController: ProductPostController = container.get('Apps.Backoffice.Backend.controllers.ProductPostController');
    ...
    const productPutImageController: ProductPutImageController = container.get('Apps.Backoffice.Backend.controllers.ProductPutImageController');

    const productGetAllController: ProductGetAllController = container.get('Apps.Backoffice.Backend.controllers.ProductGetAllController');
    const productGetByIdController: ProductGetByIdController = container.get('Apps.Backoffice.Backend.controllers.ProductGetByIdController');
    const productGetByCriteriaController: ProductGetByCriteriaController = container.get('Apps.Backoffice.Backend.controllers.ProductGetByCriteriaController');
