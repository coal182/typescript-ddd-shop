...
export class ProductImageChanged extends DomainEvent {
    ...
    constructor({aggregateId, images, eventId, occurredOn}: {aggregateId: string; images: string[]; eventId?: string; occurredOn?: Date}) {
    ...
    static fromPrimitives(params: {aggregateId: string; data: ChangeProductImageDomainEventData; eventId: string; occurredOn: Date}): DomainEvent {
