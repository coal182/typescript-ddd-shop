...
export class ProductReview extends AggregateRoot {
    ...
    static create(id: ProductReviewId, productId: ProductId, userId: UserId, rating: ProductReviewRating, comment: ProductReviewComment): ProductReview {
    ...
    static initialize(id: ProductReviewId): ProductReview {
        return new ProductReview(id, ProductId.initialize(), UserId.initialize(), new ProductReviewRating(0), new ProductReviewComment(''), new Date());
    }
    ...
    public updateProductReview(productId: ProductId, userId: UserId, rating: ProductReviewRating, comment: ProductReviewComment): void {
