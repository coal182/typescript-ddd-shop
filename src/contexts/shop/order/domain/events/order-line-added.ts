...
export class OrderLineAdded extends DomainEvent {
    ...
    constructor({aggregateId, line, eventId, occurredOn}: {aggregateId: string; line: OrderLine; eventId?: string; occurredOn?: Date}) {
    ...
    static fromPrimitives(params: {aggregateId: string; data: OrderLineAddedDomainEventData; eventId: string; occurredOn: Date}): DomainEvent {
