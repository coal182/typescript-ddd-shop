...
export class User extends AggregateRoot {
    ...
    constructor(id: UserId, email: UserEmail, firstname: UserFirstname, lastname: UserLastname, dateOfBirth: UserBirthdate, password: UserPassword);
    ...
    static create(id: UserId, email: UserEmail, firstname: UserFirstname, lastname: UserLastname, dateOfBirth: UserBirthdate, password: UserPassword): User {
    ...
    public updateUser(email: UserEmail, firstname: UserFirstname, lastname: UserLastname, dateOfBirth: UserBirthdate): void {
        this.email = email;
        this.firstname = firstname;
        this.lastname = lastname;
        this.dateOfBirth = dateOfBirth;
