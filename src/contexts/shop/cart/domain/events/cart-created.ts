...
export class CartCreated extends DomainEvent {
    ...
    constructor({aggregateId, userId, eventId, occurredOn}: {aggregateId: string; userId: string; eventId?: string; occurredOn?: Date}) {
    ...
    static fromPrimitives(params: {aggregateId: string; data: CartCreatedDomainEventData; eventId: string; occurredOn: Date}): DomainEvent {
